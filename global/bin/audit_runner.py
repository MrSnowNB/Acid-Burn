...
Discovers all Acid Burn atoms and molecules, tests each with safe mock data,
...
def generate_report(results: list[dict], discovered: list[dict], audit_ts: str) -> str:
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Report generated by system.audit.suite — Acid Burn CI/CD Pipeline*")
    lines.append("")
